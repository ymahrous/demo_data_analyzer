...
def calculate_demographic_data(print_data=True):
    ...
    lower_education_rich = lower_education_rich = round((lower_education['salary'] == '>50K').sum() / len(lower_education) * 100, 1)
    ...
    country_income = df.groupby('native-country')['salary'].value_counts(normalize=True).unstack()['>50K'] * 100
